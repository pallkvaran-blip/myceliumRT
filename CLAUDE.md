...
~553 assertions across 16 checks. **Run them; don't verify by re-reading your own diff.**
...
`tests/edit-check.cjs` covers all of it (65 assertions) and asserts on `levelSprites`, not on
