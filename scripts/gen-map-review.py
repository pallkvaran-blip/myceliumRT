...
SELECTIONS = [
    ...
    # Round four: the coloured themes swept across five counts, plus rhodonite and garnet.
    # fluorite kept at c40 only; labradorite cut outright.
    ('top-amethyst-scatter-c16-1', 'amethyst',        16, None,           'In band at 44.1%, but 567 gravel specks.'),
    ('top-amethyst-scatter-c32-1', 'amethyst',        32, None,           '45 masses at 59.9% — top of the band.'),
    ('top-malachite-scatter-c60-1', 'malachite',      60, None,           'The one malachite count kept — dense at 71.3%, but the banding holds.'),
    ('top-hematite-scatter-c16-1', 'hematite',        16, None,           '36 masses at 49.8% with NINE gravel specks — the cleanest coloured image in the set.'),
    ('top-azurite-scatter-c16-1',  'azurite',         16, None,           'Dense at 70.5%.'),
    ('top-azurite-scatter-c32-1',  'azurite',         32, None,           'Best azurite: 48 masses at 53.3%, and mean chroma 95 — the most saturated image in the project.'),
    ('top-azurite-scatter-c60-1',  'azurite',         60, None,           'Dense at 60.9%.'),
    ('top-fluorite-scatter-c40-1', 'fluorite',        40, None,           'Violet/green banding, 58 masses. The green drifts teal, which is the player\u2019s colour — watch it in game.'),
    ('top-rhodonite-scatter-c24-1', 'rhodonite',      24, None,           'Branching dendrites — the only feature in the set that forks. 50 masses at 51.1%.'),
    ('top-rhodonite-scatter-c40-1', 'rhodonite',      40, None,           '62 masses, largest blob 7%; dense at 62.8%.'),
    ('top-garnet-scatter-c24-1',   'garnet',          24, None,           'Whole embedded crystals rather than a pocket of shards. 32 masses at 39.4%.'),
    ('top-garnet-scatter-c40-1',   'garnet',          40, None,           'Denser garnet at 64.7%, better spread than c24.'),
]
